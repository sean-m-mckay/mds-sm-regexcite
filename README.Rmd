...
The goal of mds.sm.regexecite is to make regular expressions more exciting!
...
You can install the development version of mds.sm.regexecite from [GitHub](https://github.com/) with:
