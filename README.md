...
The goal of mds.sm.regexecite is to make regular expressions more
...
You can install the development version of mds.sm.regexecite from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jennybc/mds.sm.regexecite")
```
...
That’s exactly what `mds.sm.regexecite::str_split_one()` does.

``` r
library(mds.sm.regexecite)
